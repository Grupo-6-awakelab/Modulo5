...
<body id="page-top">
	...
	<div id="wrapper">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="fecha" placeholder="Fecha del accidente">
        </div>
        <div class="form-group mr-2">
								...
								<div class="form-group">
									...
									<textarea class="form-control" id="lugar" rows="1" style="max-width: 250px;"></textarea>
								</div>
								
								<div class="form-group">
									<label for="nombre">Realizado (S/N)</label>
									<textarea class="form-control" id="realizado" rows="1" style="max-width: 250px;"></textarea>
								</div>
								
								<div class="form-group">
									<label for="nombre">detalle (S/N)</label>
									<textarea class="form-control" id="detalle" rows="3" style="max-width: 250px;"></textarea>
								</div>
								
								<div class="form-group">
									<label for="nombre">Profesional ID</label>
									<textarea class="form-control" id="profesionalId" rows="1" style="max-width: 250px;"></textarea>
								</div>
