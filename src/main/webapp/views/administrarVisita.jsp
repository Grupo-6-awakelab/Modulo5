						...
						$('a[data-target="#deleteModal"]')
								.click(
										function() {
											...
											var deleteUrl = "${pageContext.request.contextPath}/administrarvisita?a=delete&id="
													+ deleteId;
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Listado de Visitas</h1>
					<p class="mb-4">Listado de todas las Visitas del sistema</p>
								...
								<table class="table table-bordered dataTable" id="dataTable"
									...
									<tbody>
										...
										<c:forEach var="visita" items="${visita}">
											...
											<tr>
												<td><c:out value="${visita.getId()}"></c:out></td>
												<td><c:out value="${visita.getClienteId()}"></c:out></td>
												<td><c:out value="${visita.getFecha()}"></c:out></td>
												<td><c:out value="${visita.getHora()}"></c:out></td>
												<td><c:out value="${visita.getLugar()}"></c:out></td>
												<td><c:out value="${visita.getRealizado()}"></c:out></td>
												<td><c:out value="${visita.getDetalle()}"></c:out></td>
												<td><c:out value="${visita.getProfesionalId()}"></c:out></td>
												<td><a
													href="${pageContext.request.contextPath}/administrarvisita?a=read&id=${visita.getId()}"><i
														class="fa-solid fa-book-open"></i></a> <a
													href="${pageContext.request.contextPath}/administrarvisita?a=edit&id=${visita.getId()}"><i
														class="fa-solid fa-pen-to-square"></i></a> <a href="#"
													data-toggle="modal" data-id="${visita.getId()}"
